...
CREATE TABLE `cinema` (
  ...
  CONSTRAINT `cinema_ibfk_2` FOREIGN KEY (`showtime_id`) REFERENCES `showtime` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `movie` (
  `id` int NOT NULL AUTO_INCREMENT,
  `title` varchar(50) DEFAULT NULL COMMENT '영화 제목',
  ...
  `director` varchar(10) DEFAULT NULL COMMENT '감독',
...
CREATE TABLE `region` (
  `id` int NOT NULL AUTO_INCREMENT,
  `location_id` int DEFAULT NULL,
  `region_name` varchar(50) DEFAULT NULL COMMENT 'ex) 강남, 강동',
  PRIMARY KEY (`id`),
  KEY `location_id` (`location_id`),
  CONSTRAINT `region_ibfk_1` FOREIGN KEY (`location_id`) REFERENCES `location` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `showtime` (
  `id` int NOT NULL AUTO_INCREMENT,
  `day` datetime DEFAULT NULL COMMENT '상영날짜',
  `start_time` datetime DEFAULT NULL COMMENT '상영 시작 시각',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
